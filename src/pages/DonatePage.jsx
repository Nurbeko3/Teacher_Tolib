...
const CARD_NUMBER = '5614 6818 1203 4217'
const CARD_RAW    = '5614681812034217'
...
export default function DonatePage({ dark = false, lang = 'uz' }) {
  ...
  const copyCard = () => {
    navigator.clipboard?.writeText(CARD_RAW).catch(() => {})
    setCopied(true)
      ...
      <section className="px-4 py-6 mx-auto w-full max-w-[520px]">
        ...
        <div className="text-center mb-7">
          <div
            ...
            style={{ background: 'linear-gradient(135deg, #b91c1c 0%, #ef4444 100%)', boxShadow: '0 8px 24px rgba(220,38,38,0.4)' }}
          >
        ...
        <div className="rounded-3xl overflow-hidden mb-4"
          ...
          <div className="mx-4 mt-4 mb-3 rounded-2xl p-5 relative overflow-hidden select-none"
            style={{ background: 'linear-gradient(135deg, #7f1d1d 0%, #b91c1c 50%, #dc2626 100%)', boxShadow: '0 12px 32px rgba(185,28,28,0.45)' }}>
            ...
            <div className="w-9 h-[26px] rounded-md mb-4 relative z-10"
              style={{ background: 'linear-gradient(135deg, #fde68a 0%, #f59e0b 100%)', boxShadow: '0 2px 8px rgba(245,158,11,0.5)' }} />
            ...
            <div className="flex items-end justify-between relative z-10">
              <div>
                ...
                <p
                  ...
                  style={{
                    background: 'linear-gradient(90deg, #fde68a 0%, #ffffff 35%, #fbbf24 55%, #ffffff 70%, #fde68a 100%)',
              ...
              <div className="text-right">
                ...
                <p className="text-white font-bold text-[13px] mt-0.5">Uzcard</p>
              </div>
            </div>
          </div>
          ...
          {sent ? (
            <div className="rounded-3xl px-6 py-10 text-center" style={{ background: wrapBg, border: `1.5px solid ${wrapBorder}` }}>
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-4"
                style={{ background: 'linear-gradient(135deg, #b91c1c 0%, #ef4444 100%)', boxShadow: '0 6px 20px rgba(220,38,38,0.4)' }}>
            ...
            <form onSubmit={handleSend} className="flex flex-col gap-3">
              ...
              <div>
                ...
                <p className="text-[12px] mb-2 leading-snug" style={{ color: subText }}>
                  {t.msgHint}
                </p>
                <textarea
